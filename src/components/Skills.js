...
const Skills = () => {
  const skills = [
    {
      name: "Tailwind CSS",
      icon: <SiTailwindcss className="text-2xl sm:text-3xl text-blue-400" />,
    ...
    {
      name: "JavaScript",
      icon: <SiJavascript className="text-2xl sm:text-3xl text-yellow-400" />,
    ...
    {
      name: "React",
      icon: <SiReact className="text-2xl sm:text-3xl text-blue-300" />,
    ...
    {
      name: "Next.js",
      icon: <SiNextdotjs className="text-2xl sm:text-3xl text-white" />,
    ...
    {
      name: "Node.js",
      icon: <SiNodedotjs className="text-2xl sm:text-3xl text-green-500" />,
    ...
    {
      name: "MongoDB",
      icon: <SiMongodb className="text-2xl sm:text-3xl text-green-400" />,
    ...
    {
      name: "Express.js",
      icon: <SiExpress className="text-2xl sm:text-3xl text-gray-400" />,
    ...
    },
    {
      name: "Better Auth",
      icon: (
        <svg className="w-6 h-6 sm:w-8 sm:h-8 text-purple-400" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: "HTML",
      icon: <SiHtml5 className="text-2xl sm:text-3xl text-orange-500" />,
    ...
    {
      name: "MySQL",
      icon: <SiMysql className="text-2xl sm:text-3xl text-blue-500" />,
    ...
    {
      name: "Docker",
      icon: <SiDocker className="text-2xl sm:text-3xl text-blue-400" />,
    ...
    {
      name: "OpenShift",
      icon: <SiRedhatopenshift className="text-2xl sm:text-3xl text-red-600" />,
    ...
    {
      name: "Git",
      icon: <SiGit className="text-2xl sm:text-3xl text-orange-600" />,
  ...
  return (
    <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-[var(--background)]" id="skills">
      ...
      {/* Skills grid:
            ...
            lg+     : 4 columns
      */}
      <div className="max-w-7xl mx-auto grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
        {skills.map((skill, index) => (
          <div
            key={index}
            className="glass-card p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl flex flex-col items-center text-center group transition-all duration-300"
          >
            {/* Icon container */}
            <div
              className={`w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 mb-3 sm:mb-4 md:mb-6 flex items-center justify-center rounded-lg sm:rounded-xl transition ${skill.bgColor} ${skill.hoverBg}`}
            >
              {skill.icon}
            </div>
